# LLM-Fuzzbench: A Microservices Framework Integrating Reasoning LLMs with AFL++

LLM-FuzzBench is an open-source microservices framework that integrates 
reasoning-capable LLMs with the AFL++ fuzzer on Google’s FuzzBench platform. 
Built on FuzzBench (commit 8b14d84f3f17b77bce65f318403a78c700bfa08d), 
the framework maintains compatibility with earlier versions of the FuzzBench platform.
It enables large-scale, reproducible experiments on LLM-guided mutation-based fuzzing, 
